...
def main():
    ...
    cart = Cart()
    # TODO: kanske spara kundinfo till maria database or sql hosted in one.com the app is live so the idea in big is already working via vercel senare
